note
	description: "Summary description for {BOOLEAN_COLUMN_METADATA}."
	author: ""
	date: "$Date: 2013-12-23 18:28:27 -0500 (Mon, 23 Dec 2013) $"
	revision: "$Revision: 8326 $"

class
	BOOLEAN_COLUMN_METADATA

inherit
	DATA_COLUMN_METADATA [BOOLEAN]
...
feature -- Status Report
	...
	conforms_to_constraint (a_value: BOOLEAN): BOOLEAN
			-- <Precursor>
		do
			Result := True
		ensure then
